...
class ScoreboardRepositoryImpl @Inject constructor(
    ...
    override suspend fun getScoreboard(sport: String, league: String, week: Int?, seasonType: Int?): ScoreboardDto {
        return api.getScoreboard(sport, league, seasonType, week)
    }
}
